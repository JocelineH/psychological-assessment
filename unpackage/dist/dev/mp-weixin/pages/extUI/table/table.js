  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "17dd88b1-7-" + i0 + "," + ("17dd88b1-6-" + i0),
        c: common_vendor.t(item.name),
        d: "17dd88b1-8-" + i0 + "," + ("17dd88b1-6-" + i0),
        e: common_vendor.t(item.address),
        f: "17dd88b1-9-" + i0 + "," + ("17dd88b1-6-" + i0),
        g: "17dd88b1-10-" + i0 + "," + ("17dd88b1-6-" + i0),
        h: index,
        i: "17dd88b1-6-" + i0 + ",17dd88b1-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "17dd88b1-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/hejing/Documents/project/newProject/pages/extUI/table/table.vue"]]);
