...
const _sfc_main = {
  ...
  methods: {
    ...
    async submit() {
      ...
      await common_vendor.index.setStorageSync("user-info", JSON.stringify(userInfo));
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/hejing/Documents/project/psychological-assessment/pages/personal/personalData.vue"]]);
